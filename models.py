...
game_ownership=db.Table('member_game',
                        db.Column('member_id',db.Integer, db.ForeignKey('member.id')),
                        db.Column('game_id',db.Integer, db.ForeignKey('game.id')))

games_at_event=db.Table('game_event',
                        db.Column('event_id',db.Integer, db.ForeignKey('event.id')),
                        db.Column('game_id',db.Integer, db.ForeignKey('game.id')))

players_at_event=db.Table('member_event',
                        db.Column('member_id',db.Integer, db.ForeignKey('member.id')),
                        db.Column('event_id',db.Integer, db.ForeignKey('event.id')))
...
class Game(db.Model):
    ...
    games_to_be_played=db.relationship('Event',secondary=games_at_event, backref=db.backref('games'))
...
class Member(db.Model):
    ...
    ownership=db.relationship('Game', secondary=game_ownership, backref=db.backref('owners'))
    participation=db.relationship('Event', secondary=players_at_event, backref=db.backref('players'))
